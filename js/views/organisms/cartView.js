...
export const cartListHeaderView = arrColumns => {
    const cartHeader = Div('felx gap-3 border-b border-black py-1 justify-between')
...
export const cartTotalView = totalPrice => {
    ...
    const totlaCol = Div('w-[20%] text-right')
    totlaCol.innerText = price2Dkk(totalPrice)

    const spacerCol = Div('w[10%]')

    totalRow.append(textCol, totlaCol, spacerCol)
